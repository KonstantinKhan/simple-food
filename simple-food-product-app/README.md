...
- **simple-food-transport-models** - модели транспортного уровня (сгенерированы из OpenAPI спецификации)
...
3. **Jackson сериализация** - настроена для работы с simple-food-transport-models
